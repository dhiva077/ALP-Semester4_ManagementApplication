...
const styles = StyleSheet.create({
  ...
  fixedSection: { paddingHorizontal: 25, backgroundColor: '#FEF2DB', paddingBottom: 5 },
  ...
  headerTitle: { flex: 1, textAlign: 'center', fontSize: 20, fontWeight: 'bold', color: '#5C2C00', marginRight: 45 },
  searchRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 20 },
  searchContainer: { flex: 1, flexDirection: 'row', alignItems: 'center', backgroundColor: '#FFF', borderRadius: 20, paddingHorizontal: 15, height: 45 },
  searchInput: { flex: 1, marginLeft: 10, fontSize: 14, color: '#5C2C00' },
  monthPicker: { backgroundColor: '#FF8F29', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 12, paddingHorizontal: 10, borderRadius: 15 },
  ...
  navArrow: { padding: 5 },
  scrollContent: { paddingHorizontal: 25, paddingTop: 15, paddingBottom: 30 },
  eventCard: { backgroundColor: '#FFFDF0', borderRadius: 25, padding: 20, marginBottom: 15, flexDirection: 'row', alignItems: 'center', elevation: 2 },
  cardInfo: { flex: 1, alignItems: 'center', marginLeft: 28 },
  eventTitle: { fontSize: 16, fontWeight: 'bold', color: '#5C2C00', textAlign: 'center', marginBottom: 6 },
  eventSubText: { fontSize: 13, color: '#5C2C00', textAlign: 'center', opacity: 0.8 },
  statusDot: { width: 20, height: 20, borderRadius: 10, marginLeft: 10 },
  emptyContainer: { alignItems: 'center', marginTop: 60, paddingHorizontal: 20 },
  emptyText: { color: '#5C2C00', opacity: 0.6, fontSize: 16, textAlign: 'center', marginTop: 15 },
});

const pickerStyles = StyleSheet.create({
  overlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'center', alignItems: 'center' },
  modal: { width: '85%', height: 420, backgroundColor: '#FFFDF0', borderRadius: 25, padding: 20 },
  modalTitle: { fontWeight: 'bold', textAlign: 'center', marginBottom: 20, color: '#5C2C00', fontSize: 18 },
  listsContainer: { flex: 1, flexDirection: 'row', gap: 12 },
  scrollCol: { flex: 1, borderWidth: 1, borderColor: '#F0F0F0', borderRadius: 15 },
  item: { padding: 15, alignItems: 'center' },
  activeItem: { backgroundColor: '#FF8F29', borderRadius: 10 },
  itemText: { color: '#5C2C00', fontSize: 14 },
  activeText: { color: '#fff', fontWeight: 'bold' },
  buttonRow: { flexDirection: 'row', marginTop: 20, gap: 10 },
  cancelBtn: { flex: 1, padding: 14, alignItems: 'center', borderRadius: 12, borderWidth: 1, borderColor: '#5C2C00' },
  confirmBtn: { flex: 1, backgroundColor: '#5C2C00', padding: 14, borderRadius: 12, alignItems: 'center' },
});