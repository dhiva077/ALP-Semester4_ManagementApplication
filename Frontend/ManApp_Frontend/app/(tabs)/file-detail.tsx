...
const styles = StyleSheet.create({
  ...
  documentPlaceholder: { height: 220, backgroundColor: '#4E2A00', width: '100%', justifyContent: 'center', alignItems: 'center' },
  cardActions: { flexDirection: 'row', justifyContent: 'space-around', paddingVertical: 15, backgroundColor: '#FFF' },
